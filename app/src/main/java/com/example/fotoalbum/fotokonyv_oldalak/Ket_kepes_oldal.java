...
public class Ket_kepes_oldal extends AppCompatActivity  implements PopupMenu.OnMenuItemClickListener{
...
//
    ...
    String Kep="Ket_kepes_oldal_elso_kep",Kep2="Ket_kepes_oldal_masodik_kep",KepNeveAdatb="",KepNeveAdatb2="";
    String oldalszamkep="";
    //
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ket_kepes_oldal);
        ...
        Oldalszam=findViewById(R.id.Oldalszam2Kep_projektek);
        btn=findViewById(R.id.btn2kepes_2);
        db=new DBHelper1(this);
        l=findViewById(R.id.l2_1);
        l1=findViewById(R.id.l2_2);
        l2=findViewById(R.id.l2_3);
        img=findViewById(R.id.imageButton2kepes_1_1);
        img1=findViewById(R.id.imageButton2kepes_1_2);
        szerkeszt=findViewById(R.id.Ket_kepes_oldal_szerkeszt);
        under=findViewById(R.id.imageView6);
        ...
        storageReference.putFile(imageUri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(Ket_kepes_oldal.this,"Successfully Uploaded",Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                if (progressDialog.isShowing())
                    progressDialog.dismiss();
                Toast.makeText(Ket_kepes_oldal.this,"Failed to Upload",Toast.LENGTH_SHORT).show();
