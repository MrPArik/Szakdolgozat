...
public class harom_kepes_oldal extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_harom_kepes_oldal);
//
...
//
        ...
        btn=findViewById(R.id.btn3kepes_2);
        db=new DBHelper1(this);
        l=findViewById(R.id.l3_1);
        l1=findViewById(R.id.l3_2);
        l2=findViewById(R.id.l3_3);
        img=findViewById(R.id.imageButton3kepes_1_1);
        img1=findViewById(R.id.imageButton3kepes_1_2);
        img2=findViewById(R.id.imageButton3kepes_1_3);
        Oldalszam=findViewById(R.id.textView7);
        szerkeszt=findViewById(R.id.Harom_kepes_oldal_Szerkeszt);
        under=findViewById(R.id.imageView4);
        ...
        storageReference.putFile(imageUri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(harom_kepes_oldal.this,"Successfully Uploaded",Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                if (progressDialog.isShowing())
                    progressDialog.dismiss();
                Toast.makeText(harom_kepes_oldal.this,"Failed to Upload",Toast.LENGTH_SHORT).show();
