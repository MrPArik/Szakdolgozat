...
public class negy_kepes_oldal extends AppCompatActivity  implements PopupMenu.OnMenuItemClickListener{
    ...
    String Kep="Negy_kepes_oldal_elso_kep",Kep2="Negy_kepes_oldal_masodik_kep",Kep3="Negy_kepes_oldal_harmadik_kep",Kep4="Negy_kepes_oldal_negyedik_kep",KepNeveAdatb="",KepNeveAdatb2="",KepNeveAdatb3="",KepNeveAdatb4="";
    String oldalszamkep="";
    //
    ...
    private final int GALLERY_REQ_CODE3=100000;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_negy_kepes_oldal);
        //
        ...
        btn=findViewById(R.id.btn4kepes_2);
        db=new DBHelper1(this);
        l=findViewById(R.id.l4_1);
        l1=findViewById(R.id.l4_2);
        l2=findViewById(R.id.l4_3);
        img=findViewById(R.id.imageButton4kepes_1_1);
        img1=findViewById(R.id.imageButton4kepes_1_2);
        img2=findViewById(R.id.imageButton4kepes_1_3);
        img3=findViewById(R.id.imageButton4kepes_1_4);
        Oldalszam=findViewById(R.id.textView9);
        szerkeszt=findViewById(R.id.Negy_Kepes_oldal_Szerkeszt);
        under=findViewById(R.id.imageView5);
        ...
        KepNeveAdatb4=cim+"_"+oldalszamkep+"_"+Kep4;
        //
        ...
        img3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(szerkesztszam==1) {
                    ...
                    Intent dsPhotoEditorIntent = new Intent(getApplicationContext(), DsPhotoEditorActivity.class);
                    dsPhotoEditorIntent.setData(imageUri3);
                    ...
                    dsPhotoEditorIntent.putExtra(DsPhotoEditorConstants.DS_PHOTO_EDITOR_TOOLS_TO_HIDE, toolsToHide);
                    startActivityForResult(dsPhotoEditorIntent, 200000);
                }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 100000 && data != null && data.getData() != null){

            imageUri3 = data.getData();
            img3.setImageURI(imageUri3);
        }
        if (requestCode == 200000 && data != null && data.getData() != null){
            Intent intent2=new Intent();
            intent2.setData(data.getData());
            img3.setImageURI(intent2.getData());
            imageUri3 = data.getData();
        }
        ...
        storageReference.putFile(imageUri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(negy_kepes_oldal.this,"Successfully Uploaded",Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                if (progressDialog.isShowing())
                    progressDialog.dismiss();
                Toast.makeText(negy_kepes_oldal.this,"Failed to Upload",Toast.LENGTH_SHORT).show();
    ...
    private void uploadImage3() {
        ...
        Date now = new Date();
        String fileName = formatter.format(now);
        storageReference = FirebaseStorage.getInstance().getReference("images/"+KepNeveAdatb4); //kep21 a kép neve
